# Software Engineering Roadmap Projects

## Overview

This repository contains a collection of projects I am building to strengthen my Software Engineering skills through practical experience.
...
* Strengthen Backend capabilities and all required langy
* Learn software architecture and design patterns
* Practice working with APIs, databases, networking, and authentication
* Build production-style projects rather than tutorial code
* Develop a portfolio that demonstrates continuous growth
...
Throughout this roadmap I expect to work with multiple languages, which will be added as they are required to finish each project.
Currently using:
